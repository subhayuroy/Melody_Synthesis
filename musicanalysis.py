...
"""<h1>Visualizing Deep Learning Models</h1>"""
...
with open('/content/network.gv', 'r') as file:
    data = file.read().replace('\n', '')

s = Source(data, filename="/content/network.gv", format="png")
s.view()

import matplotlib.pyplot as plt
import cv2

img = cv2.imread('/content/network.gv.png')
